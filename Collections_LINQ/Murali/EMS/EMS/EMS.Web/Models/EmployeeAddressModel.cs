...
namespace EMS.Web.Models
{
    public class EmployeeAddressModel
    {
        public class EmployeeAddressViewModel
        {
            ...
            public EmployeeAddressViewModel(int _EmployeeAddressModelId, string? _AddressLine1, string? _AddressLine2, string? _State, string? _City, string _Pincode, AddressTypes _AddressTypeIdFk, int _EmployeeIdFk, bool _IsActive, string _AddressTypeText)
            {
